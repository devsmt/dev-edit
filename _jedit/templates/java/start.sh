...
IZPACK_JAVA_HOME=/usr/lib/jvm/java-6-openjdk-amd64/jre
...
# SQuirreL home.
if $macosx ; then
    SQUIRREL_SQL_HOME='/usr/local/bin/squirrel-sql-3.4.0/Contents/Resources/Java'
else
    SQUIRREL_SQL_HOME='/usr/local/bin/squirrel-sql-3.4.0'
fi
